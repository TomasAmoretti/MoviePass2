...
<div class="card o-hidden border-0 shadow-lg my-5">
  <div class="card-body p-0">
    ...
    <div class="row">
      ...
      <div class="col-lg-7 movie-black">
        <div class="p-5">
          <div class="text-center">
            <h1 class="h4 text-movie-red mb-4 ">Create an Account!</h1>
          </div>

          <form class="user"  action="<?php echo FRONT_ROOT."User/Add"?>" method="POST">
            ...
            <div class="form-group">
              <input type="number" class="form-control form-control-user" name="dni" id="exampleInputDni" placeholder="DNI">
            </div>
            ...
            <!--
            <a href="" class="btn btn-primary btn-user btn-block  btn-movie-static">
              Register Account
            </a>
            <hr> -->
          ...
          <div class="text-center">
            <a class="small" href="<?php echo FRONT_ROOT."Home/Index"?>">Already have an account? Login!</a>
          </div>
        </div>
      </div>
    </div>
